...
import io.github.prolobjectlink.prolog.zprolog.ZPrologClause;
import io.github.prolobjectlink.prolog.zprolog.ZPrologClauses;
import io.github.prolobjectlink.prolog.zprolog.ZPrologGoal;
import io.github.prolobjectlink.prolog.zprolog.ZPrologProgram;
import io.github.prolobjectlink.prolog.zprolog.ZPrologTerm;
...
public class PrologProgramTest extends PrologBaseTest {
	...
	public void setUp() throws Exception {
		...
		z = new ZPrologTerm(provider, "Z", 2);
		...
		// dark rules
		z = new ZPrologTerm(provider, "Z", 0);
		...
		// parent relationship
		clauseArray[0] = new ZPrologClause(provider.newStructure(parent, pam, bob));
		clauseArray[1] = new ZPrologClause(provider.newStructure(parent, tom, bob));
		clauseArray[2] = new ZPrologClause(provider.newStructure(parent, tom, liz));
		clauseArray[3] = new ZPrologClause(provider.newStructure(parent, bob, ann));
		clauseArray[4] = new ZPrologClause(provider.newStructure(parent, bob, pat));
		clauseArray[5] = new ZPrologClause(provider.newStructure(parent, pat, jim));

		// female relationship
		clauseArray[6] = new ZPrologClause(provider.newStructure(female, pam));
		clauseArray[7] = new ZPrologClause(provider.newStructure(female, liz));
		clauseArray[8] = new ZPrologClause(provider.newStructure(female, ann));
		clauseArray[9] = new ZPrologClause(provider.newStructure(female, pat));

		// male relationship
		clauseArray[10] = new ZPrologClause(provider.newStructure(male, tom));
		clauseArray[11] = new ZPrologClause(provider.newStructure(male, bob));
		clauseArray[12] = new ZPrologClause(provider.newStructure(male, jim));

		x = new ZPrologTerm(provider, "X", 0);
		y = new ZPrologTerm(provider, "Y", 1);
		z = new ZPrologTerm(provider, "Z", 2);
		clauseArray[13] = new ZPrologClause(provider.newStructure(offspring, x, y),
				provider.newStructure(parent, x, y));

		x = new ZPrologTerm(provider, "X", 0);
		y = new ZPrologTerm(provider, "Y", 1);
		clauseArray[14] = new ZPrologClause(provider.newStructure(mother, x, y),
				provider.newStructure(",", provider.newStructure(parent, x, y), provider.newStructure(female, x)));

		x = new ZPrologTerm(provider, "X", 0);
		y = new ZPrologTerm(provider, "Y", 1);
		z = new ZPrologTerm(provider, "Z", 2);
		clauseArray[15] = new ZPrologClause(provider.newStructure(grandparent, x, z),
				provider.newStructure(",", provider.newStructure(parent, x, y), provider.newStructure(parent, y, z)));

		x = new ZPrologTerm(provider, "X", 0);
		y = new ZPrologTerm(provider, "Y", 1);
		z = new ZPrologTerm(provider, "Z", 2);
		clauseArray[16] = new ZPrologClause(provider.newStructure(sister, x, y),
				provider.newStructure(",", provider.newStructure(parent, z, x),
						provider.newStructure(",", provider.newStructure(parent, z, y), provider.newStructure(",",
								provider.newStructure(female, x), provider.newStructure(different, x, y)))));

		x = new ZPrologTerm(provider, "X", 0);
		clauseArray[17] = new ZPrologClause(provider.newStructure(different, x, x),
				provider.newStructure(",", provider.prologCut(), provider.prologFail()));

		x = new ZPrologTerm(provider, "X", 0);
		y = new ZPrologTerm(provider, "Y", 1);
		clauseArray[18] = new ZPrologClause(provider.newStructure(different, x, y));

		x = new ZPrologTerm(provider, "X", 0);
		y = new ZPrologTerm(provider, "Y", 1);
		z = new ZPrologTerm(provider, "Z", 2);
		clauseArray[19] = new ZPrologClause(provider.newStructure(predecessor, x, z),
				provider.newStructure(parent, x, z));

		x = new ZPrologTerm(provider, "X", 0);
		y = new ZPrologTerm(provider, "Y", 1);
		z = new ZPrologTerm(provider, "Z", 2);
		clauseArray[20] = new ZPrologClause(provider.newStructure(predecessor, x, z), provider.newStructure(",",
				provider.newStructure(parent, x, y), provider.newStructure(predecessor, y, z)));

		// employee relationship
		clauseArray[21] = new ZPrologClause(provider.newStructure(employee, mcardon, one, five));
		clauseArray[22] = new ZPrologClause(provider.newStructure(employee, treeman, two, three));
		clauseArray[23] = new ZPrologClause(provider.newStructure(employee, chapman, one, two));
		clauseArray[24] = new ZPrologClause(provider.newStructure(employee, petersen, five, eight));
		clauseArray[26] = new ZPrologClause(provider.newStructure(employee, cohn, one, seven));
		clauseArray[27] = new ZPrologClause(provider.newStructure(employee, duffy, one, nine));

		// department relationship
		clauseArray[28] = new ZPrologClause(provider.newStructure(department, one, board));
		clauseArray[29] = new ZPrologClause(provider.newStructure(department, two, human_resources));
		clauseArray[30] = new ZPrologClause(provider.newStructure(department, three, production));
		clauseArray[31] = new ZPrologClause(provider.newStructure(department, four, technical_services));
		clauseArray[32] = new ZPrologClause(provider.newStructure(department, five, administration));

		// salary relationship
		clauseArray[33] = new ZPrologClause(provider.newStructure(salary, one, thousand));
		clauseArray[34] = new ZPrologClause(provider.newStructure(salary, two, thousandFiveHundred));
		clauseArray[35] = new ZPrologClause(provider.newStructure(salary, three, twoThousand));
		clauseArray[36] = new ZPrologClause(provider.newStructure(salary, four, twoThousandFiveHundred));
		clauseArray[37] = new ZPrologClause(provider.newStructure(salary, five, threeThousand));
		clauseArray[38] = new ZPrologClause(provider.newStructure(salary, six, threeThousandFiveHundred));
		clauseArray[39] = new ZPrologClause(provider.newStructure(salary, seven, fourThousand));
		clauseArray[40] = new ZPrologClause(provider.newStructure(salary, eight, fourThousandFiveHundred));
		clauseArray[41] = new ZPrologClause(provider.newStructure(salary, nine, fiveThousand));

		// zoo relationships
		clauseArray[42] = new ZPrologClause(provider.newStructure("big", bear));
		clauseArray[43] = new ZPrologClause(provider.newStructure("big", elephant));
		clauseArray[44] = new ZPrologClause(provider.newStructure("small", cat));
		clauseArray[45] = new ZPrologClause(provider.newStructure("brown", bear));
		clauseArray[46] = new ZPrologClause(provider.newStructure("black", cat));
		clauseArray[47] = new ZPrologClause(provider.newStructure("gray", elephant));

		// dark rules
		z = new ZPrologTerm(provider, "Z", 0);
		clauseArray[48] = new ZPrologClause(provider.newStructure("dark", z), provider.newStructure("black", z));

		z = new ZPrologTerm(provider, "Z", 0);
		clauseArray[49] = new ZPrologClause(provider.newStructure("dark", z), provider.newStructure("brown", z));
	...
	public final void testAddIPrologClause() {
		...
		PrologProgram otherProgram = new ZPrologProgram();
		assertEquals(0, otherProgram.size());
		assertTrue(otherProgram.isEmpty());

		// parent relationship
		otherProgram.add(new ZPrologClause(provider.newStructure(parent, pam, bob)));
		otherProgram.add(new ZPrologClause(provider.newStructure(parent, tom, bob)));
		otherProgram.add(new ZPrologClause(provider.newStructure(parent, tom, liz)));
		otherProgram.add(new ZPrologClause(provider.newStructure(parent, bob, ann)));
		otherProgram.add(new ZPrologClause(provider.newStructure(parent, bob, pat)));
		otherProgram.add(new ZPrologClause(provider.newStructure(parent, pat, jim)));

		// female relationship
		otherProgram.add(new ZPrologClause(provider.newStructure(female, pam)));
		otherProgram.add(new ZPrologClause(provider.newStructure(female, liz)));
		otherProgram.add(new ZPrologClause(provider.newStructure(female, ann)));
		otherProgram.add(new ZPrologClause(provider.newStructure(female, pat)));

		// male relationship
		otherProgram.add(new ZPrologClause(provider.newStructure(male, tom)));
		otherProgram.add(new ZPrologClause(provider.newStructure(male, bob)));
		otherProgram.add(new ZPrologClause(provider.newStructure(male, jim)));

		x = new ZPrologTerm(provider, "X", 0);
		y = new ZPrologTerm(provider, "Y", 1);
		z = new ZPrologTerm(provider, "Z", 2);
		otherProgram
				.add(new ZPrologClause(provider.newStructure(offspring, x, y), provider.newStructure(parent, x, y)));

		x = new ZPrologTerm(provider, "X", 0);
		y = new ZPrologTerm(provider, "Y", 1);
		otherProgram.add(new ZPrologClause(provider.newStructure(mother, x, y),
				provider.newStructure(",", provider.newStructure(parent, x, y), provider.newStructure(female, x))));

		x = new ZPrologTerm(provider, "X", 0);
		y = new ZPrologTerm(provider, "Y", 1);
		z = new ZPrologTerm(provider, "Z", 2);
		otherProgram.add(new ZPrologClause(provider.newStructure(grandparent, x, z),
				provider.newStructure(",", provider.newStructure(parent, x, y), provider.newStructure(parent, y, z))));

		x = new ZPrologTerm(provider, "X", 0);
		y = new ZPrologTerm(provider, "Y", 1);
		z = new ZPrologTerm(provider, "Z", 2);
		otherProgram.add(new ZPrologClause(provider.newStructure(sister, x, y),
				provider.newStructure(",", provider.newStructure(parent, z, x),
						provider.newStructure(",", provider.newStructure(parent, z, y), provider.newStructure(",",
								provider.newStructure(female, x), provider.newStructure(different, x, y))))));

		x = new ZPrologTerm(provider, "X", 0);
		otherProgram.add(new ZPrologClause(provider.newStructure(different, x, x),
				provider.newStructure(",", provider.prologCut(), provider.prologFail())));

		x = new ZPrologTerm(provider, "X", 0);
		y = new ZPrologTerm(provider, "Y", 1);
		otherProgram.add(new ZPrologClause(provider.newStructure(different, x, y)));
		...
		y = new ZPrologTerm(provider, "Y", 1);
		z = new ZPrologTerm(provider, "Z", 2);
		otherProgram.add(new ZPrologClause(provider.newStructure(predecessor, x, z), provider.newStructure(",",
				provider.newStructure(parent, x, y), provider.newStructure(predecessor, y, z))));

		// employee relationship
		otherProgram.add(new ZPrologClause(provider.newStructure(employee, mcardon, one, five)));
		otherProgram.add(new ZPrologClause(provider.newStructure(employee, treeman, two, three)));
		otherProgram.add(new ZPrologClause(provider.newStructure(employee, chapman, one, two)));
		otherProgram.add(new ZPrologClause(provider.newStructure(employee, claessen, four, one)));
		otherProgram.add(new ZPrologClause(provider.newStructure(employee, petersen, five, eight)));
		otherProgram.add(new ZPrologClause(provider.newStructure(employee, cohn, one, seven)));
		otherProgram.add(new ZPrologClause(provider.newStructure(employee, duffy, one, nine)));

		// department relationship
		otherProgram.add(new ZPrologClause(provider.newStructure(department, one, board)));
		otherProgram.add(new ZPrologClause(provider.newStructure(department, two, human_resources)));
		otherProgram.add(new ZPrologClause(provider.newStructure(department, three, production)));
		otherProgram.add(new ZPrologClause(provider.newStructure(department, four, technical_services)));
		otherProgram.add(new ZPrologClause(provider.newStructure(department, five, administration)));

		// salary relationship
		otherProgram.add(new ZPrologClause(provider.newStructure(salary, one, thousand)));
		otherProgram.add(new ZPrologClause(provider.newStructure(salary, two, thousandFiveHundred)));
		otherProgram.add(new ZPrologClause(provider.newStructure(salary, three, twoThousand)));
		otherProgram.add(new ZPrologClause(provider.newStructure(salary, four, twoThousandFiveHundred)));
		otherProgram.add(new ZPrologClause(provider.newStructure(salary, five, threeThousand)));
		otherProgram.add(new ZPrologClause(provider.newStructure(salary, six, threeThousandFiveHundred)));
		otherProgram.add(new ZPrologClause(provider.newStructure(salary, seven, fourThousand)));
		otherProgram.add(new ZPrologClause(provider.newStructure(salary, eight, fourThousandFiveHundred)));
		otherProgram.add(new ZPrologClause(provider.newStructure(salary, nine, fiveThousand)));

		// zoo relationships
		otherProgram.add(new ZPrologClause(provider.newStructure("big", bear)));
		otherProgram.add(new ZPrologClause(provider.newStructure("big", elephant)));
		otherProgram.add(new ZPrologClause(provider.newStructure("small", cat)));
		otherProgram.add(new ZPrologClause(provider.newStructure("brown", bear)));
		otherProgram.add(new ZPrologClause(provider.newStructure("black", cat)));
		otherProgram.add(new ZPrologClause(provider.newStructure("gray", elephant)));

		// dark rules
		z = new ZPrologTerm(provider, "Z", 0);
		otherProgram.add(new ZPrologClause(provider.newStructure("dark", z), provider.newStructure("black", z)));

		z = new ZPrologTerm(provider, "Z", 0);
		otherProgram.add(new ZPrologClause(provider.newStructure("dark", z), provider.newStructure("brown", z)));
	...
	public final void testPush() {
		...
		otherProgram.push(new ZPrologClause(provider.newStructure(parent, pat, jim)));
		otherProgram.push(new ZPrologClause(provider.newStructure(parent, bob, pat)));
		otherProgram.push(new ZPrologClause(provider.newStructure(parent, bob, ann)));
		otherProgram.push(new ZPrologClause(provider.newStructure(parent, tom, liz)));
		otherProgram.push(new ZPrologClause(provider.newStructure(parent, tom, bob)));
		otherProgram.push(new ZPrologClause(provider.newStructure(parent, pam, bob)));

		otherProgram.push(new ZPrologClause(provider.newStructure(female, pat)));
		otherProgram.push(new ZPrologClause(provider.newStructure(female, ann)));
		otherProgram.push(new ZPrologClause(provider.newStructure(female, liz)));
		otherProgram.push(new ZPrologClause(provider.newStructure(female, pam)));

		otherProgram.push(new ZPrologClause(provider.newStructure(male, jim)));
		otherProgram.push(new ZPrologClause(provider.newStructure(male, bob)));
		otherProgram.push(new ZPrologClause(provider.newStructure(male, tom)));

		x = new ZPrologTerm(provider, "X", 0);
		y = new ZPrologTerm(provider, "Y", 1);
		z = new ZPrologTerm(provider, "Z", 2);
		otherProgram
				.push(new ZPrologClause(provider.newStructure(offspring, x, y), provider.newStructure(parent, x, y)));

		x = new ZPrologTerm(provider, "X", 0);
		y = new ZPrologTerm(provider, "Y", 1);
		otherProgram.push(new ZPrologClause(provider.newStructure(mother, x, y),
				provider.newStructure(",", provider.newStructure(parent, x, y), provider.newStructure(female, x))));

		x = new ZPrologTerm(provider, "X", 0);
		y = new ZPrologTerm(provider, "Y", 1);
		z = new ZPrologTerm(provider, "Z", 2);
		otherProgram.push(new ZPrologClause(provider.newStructure(grandparent, x, z),
				provider.newStructure(",", provider.newStructure(parent, x, y), provider.newStructure(parent, y, z))));

		x = new ZPrologTerm(provider, "X", 0);
		y = new ZPrologTerm(provider, "Y", 1);
		z = new ZPrologTerm(provider, "Z", 2);
		otherProgram.push(new ZPrologClause(provider.newStructure(sister, x, y),
				provider.newStructure(",", provider.newStructure(parent, z, x),
						provider.newStructure(",", provider.newStructure(parent, z, y), provider.newStructure(",",
								provider.newStructure(female, x), provider.newStructure(different, x, y))))));
		...
		x = new ZPrologTerm(provider, "X", 0);
		y = new ZPrologTerm(provider, "Y", 1);
		otherProgram.push(new ZPrologClause(provider.newStructure(different, x, y)));

		x = new ZPrologTerm(provider, "X", 0);
		otherProgram.push(new ZPrologClause(provider.newStructure(different, x, x),
				provider.newStructure(",", provider.prologCut(), provider.prologFail())));

		x = new ZPrologTerm(provider, "X", 0);
		y = new ZPrologTerm(provider, "Y", 1);
		z = new ZPrologTerm(provider, "Z", 2);
		otherProgram.push(new ZPrologClause(provider.newStructure(predecessor, x, z), provider.newStructure(",",
				provider.newStructure(parent, x, y), provider.newStructure(predecessor, y, z))));
		...
		z = new ZPrologTerm(provider, "Z", 2);
		otherProgram
				.push(new ZPrologClause(provider.newStructure(predecessor, x, z), provider.newStructure(parent, x, z)));

		otherProgram.push(new ZPrologClause(provider.newStructure(employee, duffy, one, nine)));
		otherProgram.push(new ZPrologClause(provider.newStructure(employee, cohn, one, seven)));
		otherProgram.push(new ZPrologClause(provider.newStructure(employee, petersen, five, eight)));
		otherProgram.push(new ZPrologClause(provider.newStructure(employee, claessen, four, one)));
		otherProgram.push(new ZPrologClause(provider.newStructure(employee, chapman, one, two)));
		otherProgram.push(new ZPrologClause(provider.newStructure(employee, treeman, two, three)));
		otherProgram.push(new ZPrologClause(provider.newStructure(employee, mcardon, one, five)));

		otherProgram.push(new ZPrologClause(provider.newStructure(department, five, administration)));
		otherProgram.push(new ZPrologClause(provider.newStructure(department, four, technical_services)));
		otherProgram.push(new ZPrologClause(provider.newStructure(department, three, production)));
		otherProgram.push(new ZPrologClause(provider.newStructure(department, two, human_resources)));
		otherProgram.push(new ZPrologClause(provider.newStructure(department, one, board)));

		otherProgram.push(new ZPrologClause(provider.newStructure(salary, nine, fiveThousand)));
		otherProgram.push(new ZPrologClause(provider.newStructure(salary, eight, fourThousandFiveHundred)));
		otherProgram.push(new ZPrologClause(provider.newStructure(salary, seven, fourThousand)));
		otherProgram.push(new ZPrologClause(provider.newStructure(salary, six, threeThousandFiveHundred)));
		otherProgram.push(new ZPrologClause(provider.newStructure(salary, five, threeThousand)));
		otherProgram.push(new ZPrologClause(provider.newStructure(salary, four, twoThousandFiveHundred)));
		otherProgram.push(new ZPrologClause(provider.newStructure(salary, three, twoThousand)));
		otherProgram.push(new ZPrologClause(provider.newStructure(salary, two, thousandFiveHundred)));
		otherProgram.push(new ZPrologClause(provider.newStructure(salary, one, thousand)));

		otherProgram.push(new ZPrologClause(provider.newStructure("gray", elephant)));
		otherProgram.push(new ZPrologClause(provider.newStructure("black", cat)));
		otherProgram.push(new ZPrologClause(provider.newStructure("brown", bear)));
		otherProgram.push(new ZPrologClause(provider.newStructure("small", cat)));
		otherProgram.push(new ZPrologClause(provider.newStructure("big", elephant)));
		otherProgram.push(new ZPrologClause(provider.newStructure("big", bear)));

		z = new ZPrologTerm(provider, "Z", 0);
		otherProgram.push(new ZPrologClause(provider.newStructure("dark", z), provider.newStructure("brown", z)));

		z = new ZPrologTerm(provider, "Z", 0);
		otherProgram.push(new ZPrologClause(provider.newStructure("dark", z), provider.newStructure("black", z)));
	...
	public final void testRemove() {
		...
		// parent relationship
		program.remove(new ZPrologClause(provider.newStructure(parent, pam, bob)));
		program.remove(new ZPrologClause(provider.newStructure(parent, tom, bob)));
		program.remove(new ZPrologClause(provider.newStructure(parent, tom, liz)));
		program.remove(new ZPrologClause(provider.newStructure(parent, bob, ann)));
		program.remove(new ZPrologClause(provider.newStructure(parent, bob, pat)));
		program.remove(new ZPrologClause(provider.newStructure(parent, pat, jim)));

		// female relationship
		program.remove(new ZPrologClause(provider.newStructure(female, pam)));
		program.remove(new ZPrologClause(provider.newStructure(female, liz)));
		program.remove(new ZPrologClause(provider.newStructure(female, ann)));
		program.remove(new ZPrologClause(provider.newStructure(female, pat)));

		// male relationship
		program.remove(new ZPrologClause(provider.newStructure(male, tom)));
		program.remove(new ZPrologClause(provider.newStructure(male, bob)));
		program.remove(new ZPrologClause(provider.newStructure(male, jim)));

		x = new ZPrologTerm(provider, "X", 0);
		y = new ZPrologTerm(provider, "Y", 1);
		z = new ZPrologTerm(provider, "Z", 2);
		program.remove(new ZPrologClause(provider.newStructure(offspring, x, y), provider.newStructure(parent, x, y)));

		x = new ZPrologTerm(provider, "X", 0);
		y = new ZPrologTerm(provider, "Y", 1);
		program.remove(new ZPrologClause(provider.newStructure(mother, x, y),
				provider.newStructure(",", provider.newStructure(parent, x, y), provider.newStructure(female, x))));

		x = new ZPrologTerm(provider, "X", 0);
		y = new ZPrologTerm(provider, "Y", 1);
		z = new ZPrologTerm(provider, "Z", 2);
		program.remove(new ZPrologClause(provider.newStructure(grandparent, x, z),
				provider.newStructure(",", provider.newStructure(parent, x, y), provider.newStructure(parent, y, z))));

		x = new ZPrologTerm(provider, "X", 0);
		y = new ZPrologTerm(provider, "Y", 1);
		z = new ZPrologTerm(provider, "Z", 2);
		program.remove(new ZPrologClause(provider.newStructure(sister, x, y),
				provider.newStructure(",", provider.newStructure(parent, z, x),
						provider.newStructure(",", provider.newStructure(parent, z, y), provider.newStructure(",",
								provider.newStructure(female, x), provider.newStructure(different, x, y))))));

		x = new ZPrologTerm(provider, "X", 0);
		program.remove(new ZPrologClause(provider.newStructure(different, x, x),
				provider.newStructure(",", provider.prologCut(), provider.prologFail())));

		x = new ZPrologTerm(provider, "X", 0);
		y = new ZPrologTerm(provider, "Y", 1);
		program.remove(new ZPrologClause(provider.newStructure(different, x, y)));

		x = new ZPrologTerm(provider, "X", 0);
		y = new ZPrologTerm(provider, "Y", 1);
		z = new ZPrologTerm(provider, "Z", 2);
		program.remove(
				new ZPrologClause(provider.newStructure(predecessor, x, z), provider.newStructure(parent, x, z)));

		x = new ZPrologTerm(provider, "X", 0);
		y = new ZPrologTerm(provider, "Y", 1);
		z = new ZPrologTerm(provider, "Z", 2);
		program.remove(new ZPrologClause(provider.newStructure(predecessor, x, z), provider.newStructure(",",
				provider.newStructure(parent, x, y), provider.newStructure(predecessor, y, z))));

		// employee relationship
		program.remove(new ZPrologClause(provider.newStructure(employee, mcardon, one, five)));
		program.remove(new ZPrologClause(provider.newStructure(employee, treeman, two, three)));
		program.remove(new ZPrologClause(provider.newStructure(employee, chapman, one, two)));
		program.remove(new ZPrologClause(provider.newStructure(employee, claessen, four, one)));
		program.remove(new ZPrologClause(provider.newStructure(employee, petersen, five, eight)));
		program.remove(new ZPrologClause(provider.newStructure(employee, cohn, one, seven)));
		program.remove(new ZPrologClause(provider.newStructure(employee, duffy, one, nine)));

		// department relationship
		program.remove(new ZPrologClause(provider.newStructure(department, one, board)));
		program.remove(new ZPrologClause(provider.newStructure(department, two, human_resources)));
		program.remove(new ZPrologClause(provider.newStructure(department, three, production)));
		program.remove(new ZPrologClause(provider.newStructure(department, four, technical_services)));
		program.remove(new ZPrologClause(provider.newStructure(department, five, administration)));

		// salary relationship
		program.remove(new ZPrologClause(provider.newStructure(salary, one, thousand)));
		program.remove(new ZPrologClause(provider.newStructure(salary, two, thousandFiveHundred)));
		program.remove(new ZPrologClause(provider.newStructure(salary, three, twoThousand)));
		program.remove(new ZPrologClause(provider.newStructure(salary, four, twoThousandFiveHundred)));
		program.remove(new ZPrologClause(provider.newStructure(salary, five, threeThousand)));
		program.remove(new ZPrologClause(provider.newStructure(salary, six, threeThousandFiveHundred)));
		program.remove(new ZPrologClause(provider.newStructure(salary, seven, fourThousand)));
		program.remove(new ZPrologClause(provider.newStructure(salary, eight, fourThousandFiveHundred)));
		program.remove(new ZPrologClause(provider.newStructure(salary, nine, fiveThousand)));

		// zoo relationships
		program.remove(new ZPrologClause(provider.newStructure("big", bear)));
		program.remove(new ZPrologClause(provider.newStructure("big", elephant)));
		program.remove(new ZPrologClause(provider.newStructure("small", cat)));
		program.remove(new ZPrologClause(provider.newStructure("brown", bear)));
		program.remove(new ZPrologClause(provider.newStructure("black", cat)));
		program.remove(new ZPrologClause(provider.newStructure("gray", elephant)));

		// dark rules
		z = new ZPrologTerm(provider, "Z", 0);
		program.remove(new ZPrologClause(provider.newStructure("dark", z), provider.newStructure("black", z)));

		z = new ZPrologTerm(provider, "Z", 0);
		program.remove(new ZPrologClause(provider.newStructure("dark", z), provider.newStructure("brown", z)));
