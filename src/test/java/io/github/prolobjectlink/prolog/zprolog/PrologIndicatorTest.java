...
public class PrologIndicatorTest extends PrologBaseTest {
	...
	private final PrologIndicator pi = new ZPrologIndicator("functor", 3);
	...
	public final void testHashCode() {
		assertEquals(new ZPrologIndicator("functor", 3).hashCode(), pi.hashCode());
	}

	@Test
	public final void testEquals() {
		assertEquals(new ZPrologIndicator("functor", 3), pi);
	}
