...
public abstract class PrologBaseTest {
	...
	protected static final PrologProvider provider = PrologFactory.newProvider(ZPrologProvider.class);
	...
	public static void printSolution(PrologQuery query) {
		Map<String, PrologTerm> solutionMap;
		System.out.println();
		if (query.hasSolution()) {
			solutionMap = query.oneVariablesSolution();
			Set<String> keySet = solutionMap.keySet();
			for (String key : keySet) {
				System.out.println(key + " = " + solutionMap.get(key));
			}
			// System.out.println("Unifications: " + query.getUnifications());
			// System.out.println("Backtrackings: " + query.getBacktracks());
			// System.out.println("Query time: " + query.getDuration());
			// System.out.println("Yes");
		} else {
			// if (query.hasCause()) {
			// System.out.println(query.getCause());
			// }
	...
	public static void printSolution(PrologTerm[] result) {
	...
	public static void printVariablesSolution(Map<String, PrologTerm> solutionMap) {
		Set<String> keySet = solutionMap.keySet();
		for (String key : keySet) {
			System.out.println(key + " = " + solutionMap.get(key));
		}
	...
	public static void printSolution(PrologTerm[][] allSolution) {
	...
	public static void printVariablesSolution(Map<String, PrologTerm>[] allSolution) {
		for (int i = 0; i < allSolution.length; i++) {
			Map<String, PrologTerm> solutionMap = allSolution[i];
			Set<String> keySet = solutionMap.keySet();
			for (String key : keySet) {
				System.out.println(key + " = " + solutionMap.get(key));
			}
